...
export default function AddItem(props) {
    ...
    const [chorePriority, setChorePriority] = useState(3)
    ...
    function sumbmit() {
        ...
        } else if (sectionSelect === 'Chores') {
            newEntry = {name:name, type:sectionSelect, chorePriority:chorePriority, level:0}
            // placeholder... remove before implementing chores add
            // return
        }
    ...
    return (
        <>
            ...
            <div className='addSlider'>
                ...
                <button className='button-mid' 
                    style={{color: sectionSelect === 'Chores' ? '#a2f3fc' : 'white'}}
                    onClick={() => setSectionSelect('Chores')}
                >
